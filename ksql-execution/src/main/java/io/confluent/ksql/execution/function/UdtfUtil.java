...
public final class UdtfUtil {
  ...
  public static KsqlTableFunction<?, ?> resolveTableFunction(
    ...
    try {
      ...
      final KsqlTableFunction tableFunctionInfo = functionRegistry.getTableFunction(
      ...
      final int udtfIndex = schema.valueColumnIndex(args.get(0)).getAsInt();

      return tableFunctionInfo.getInstance(new TableFunctionArguments(udtfIndex, args));
